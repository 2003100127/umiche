...
if __name__ == "__main__":
    ...
    # df = pd.DataFrame()
    # print(df_bam[["CB", "XT"]].shape)
    # df_bam = df_bam.drop_duplicates(subset=["CB", "XT"])
    # print(df_bam[["CB", "XT"]].shape)
    # df['target_id'] = list(zip(df_bam["CB"], df_bam["XT"]))
    # print(df['target_id'])
    # print(df.shape)
    # df['tpm'] = 1
    # df['cell'] = '.'
    # df.to_csv(
    #     '/mnt/d/Document/Programming/Python/umiche/umiche/data/r1/cmi/abundance.tsv',
    #     header=True,
    # sep='\t',
    # index=False)
    ...
    for mut_rate in mut_rates:
        ...
        df_bam["MB"] = df_bam["MB"].apply(lambda umi: Error().mutated(umi, mut_rate=mut_rate, mode="normal"))
        ...
        p = Spikein(
            ...
            work_dir='/mnt/d/Document/Programming/Python/umiche/umiche/data/r1/cmi/ed1/',
