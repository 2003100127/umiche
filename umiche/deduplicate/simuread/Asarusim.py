...
if __name__ == "__main__":
    ...
    # @@ /*** -------------------- ***/
    bam_fpn = "/mnt/d/Document/Programming/Python/umiche/umiche/data/r1/simuread/asarusim/results_demo/simulated_with_tags.bam"
    from umiche.bam.Reader import ReaderChunk
    df_bam = ReaderChunk(
        bam_fpn=bam_fpn,
        bam_fields=['contig', 'pos', 'CIGAR', 'read'],
        tag_whitelist=['CB', 'MB', 'XT'],
        verbose=True,
    ...
    for mut_rate in mut_rates:
        ...
        #
        #     work_dir='/mnt/d/Document/Programming/Python/umiche/umiche/data/r1/simuread/asarusim/ed1/',
        #
        #     mcl_fold_thres=1.5,
        #     inflat_val=1.6,
        #     exp_val=2,
