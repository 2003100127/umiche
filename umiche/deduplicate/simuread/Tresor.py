...
class Tresor:
    ...
    def __init__(
        ...
        self.console.print(
            '======># of conditions given by the granularity level list: {}'.format(len(self.pos_gp_keys)))
        pos_gps = []
        res_sum = []
...
if __name__ == "__main__":
    ...
    for mut_rate in mut_rates:
        ...
        #
        #     work_dir='/mnt/d/Document/Programming/Python/umiche/umiche/data/r1/simuread/tresor/ed1_ht_spl_pct10/',
        #
        #     mcl_fold_thres=1.5,
        #     inflat_val=1.6,
        #     exp_val=2,
