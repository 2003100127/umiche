...
def edgeColors(edge_list, node_colors):
    ...
    for i, edge in enumerate(edge_list):
        # print(edge)
        if edge == [12, 185]:
            print(node_colors[edge[0]])
            print(node_colors[edge[1]])
        colors_.append(node_colors[edge[1]])
    return colors_


nodes1 = makeNodes(ccs=ccs)
print(nodes1)
node_colors1 = nodeColors(ccs=ccs, palette=palette)
print(node_colors1)
edge_colors1 = edgeColors(edge_list=edge_list, node_colors=node_colors1)
print(edge_colors1)

options1 = {
    "font_size": 8,
    "node_size": 100,
    "node_color": [*node_colors1.values()],
    "edgecolors": [*node_colors1.values()],
    "linewidths": 1,
    "width": 1,
}

nodes2 = makeNodes(ccs=mcl)
print(nodes2)
node_colors2 = nodeColors(ccs=mcl, palette=palette)
print(node_colors2)
edge_colors2 = edgeColors(edge_list=edge_list, node_colors=node_colors2)
print(edge_colors2)
options2 = {
    "font_size": 8,
    "node_size": 100,
    "node_color": [*node_colors2.values()],
    "edgecolors": [*node_colors2.values()],
    "linewidths": 1,
    "width": 1,
}

G1 = nx.Graph()
G1.add_nodes_from(makeNodes(ccs))
